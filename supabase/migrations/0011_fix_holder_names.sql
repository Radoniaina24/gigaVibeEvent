-- ============================================================
-- 0011_fix_holder_names.sql — Corrige l'erreur
--   `operator does not exist: text #>> unknown`
-- dans create_checkout_order() : `jsonb_array_elements_text()` renvoie
-- déjà du TEXT, l'opérateur `#>>` (réservé à jsonb) est donc invalide.
-- Sans ce fix, TOUTE commande avec noms de participants échoue.
-- À exécuter APRÈS 0010 (SQL Editor ou `supabase db push`).
-- ============================================================
...
begin
  ...
  for v_item in select * from jsonb_array_elements(p_items) loop
    ...
    -- NOTE : jsonb_array_elements_text() renvoie du TEXT : pas de `#>>`.
