...
/**
 * Barre supérieure de l'espace organisateur (même style que la topbar admin) :
 * bouton menu (mobile), repli sidebar (desktop), fil d'Ariane, cloche des
 * paiements en attente (pastille), accès site et compte.
 */
