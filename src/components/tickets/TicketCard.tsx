...
/**
 * Billet événementiel : bandeau marque avec logo, corps d'infos,
 * perforation et souche QR à scanner. Empilé sur mobile, côte à côte dès `sm`.
 */
  ...
  return (
    <Card className="min-w-0 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-stretch">
        ...
        {/* Souche QR */}
        <div className="flex items-center gap-3 p-4 sm:w-48 sm:flex-col sm:justify-center sm:p-5">
          <div
            ref={qrRef}
            role="img"
            aria-label={`QR Code du billet ${ticket.ticket_number}`}
            className={cn(
              'shrink-0 rounded-xl border border-zinc-200 bg-white p-2',
